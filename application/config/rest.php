...
|
*/
$config['force_https'] = false;//ativar online
...
|
*/
$config['rest_default_format'] = 'json';//por json
...
|
*/
$config['rest_valid_logins'] = ['adminsenac' => '@-senac#Paulodir(web)'];//por login especifico
...
|
*/
$config['rest_keys_table'] = 'token';//onde esta a tabela com a chave de acesso
